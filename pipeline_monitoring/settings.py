...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-jq!_5i_g4rptt1ia=1i3xra!_hmq+!pdo=2gn898ofyq3ni75&')
...
if platform.system() == 'Windows':
    ...
    DEFAULT_GDAL_PATH = os.environ.get(
        'GDAL_LIBRARY_PATH',
        r'C:\Users\USER\anaconda3\envs\gdal_1\Library\bin\gdal.dll'
    )
