    ...
    def to_representation(self, instance):
        ...
        try:
            if hasattr(instance, "preferences") and instance.preferences:
                representation["preferences"] = UserPreferenceSerializer(
...
class UserCreateSerializer(DjoserUserCreateSerializer):
    ...
    def save(self, **kwargs):
        ...
        # Log for debugging
        logger.error(
            f"Final validated_data before create_user: username={validated_data.get('username')}, email={validated_data.get('email')}"
        )
